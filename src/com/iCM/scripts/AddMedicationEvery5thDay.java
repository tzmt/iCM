...
public class AddMedicationEvery5thDay extends DriverTestCase
{	
	@Test
	public void testAddMedicationEvery5thDay() throws Exception
	{			
		//Initialize objects
		...
		try{
			...
			residentHelper = new ResidentHelper(getWebDriver());
				...
				echartHelper.select("AddMedication.FrequencyDrpdwn","Every 5th day");
				ExecutionLog.Log("Pass");
				...
				echartHelper.verifyBlackOutOtherDay("Every 5th day");
				ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testAddMedicationEvery5thDay");	
