...
public class EMRAdminResidentRefused extends DriverTestCase
{	
	@Test
	public void testEMRAdminResidentRefused() throws Exception
	{			
		...
		try{
			...
			residentHelper = new ResidentHelper(getWebDriver());
				...
				eMRHelper.verifyItemText("Admin.SavedRefused","Resident Refused");
				ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testEMRAdminResidentRefused");	
