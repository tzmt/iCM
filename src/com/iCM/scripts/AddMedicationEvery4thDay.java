...
public class AddMedicationEvery4thDay extends DriverTestCase
{	
	@Test
	public void testAddMedicationEvery4thDay() throws Exception
	{			
		//Initialize objects
		...
		try{
			...
			residentHelper = new ResidentHelper(getWebDriver());
				...
				echartHelper.select("AddMedication.FrequencyDrpdwn","Every 4th day");
				ExecutionLog.Log("Pass");
				...
				echartHelper.verifyBlackOutOtherDay("Every 4th day");
				ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testAddMedicationEvery4thDay");	
