...
public class AddMedicationEvery10thDay extends DriverTestCase
{	
	@Test
	public void testAddMedicationEvery10thDay() throws Exception
	{			
		//Initialize objects
		...
		try{
			...
			residentHelper = new ResidentHelper(getWebDriver());
				...
				echartHelper.select("AddMedication.FrequencyDrpdwn","Every 10 days");
				ExecutionLog.Log("Pass");
				...
				echartHelper.verifyBlackOutOtherDay("Every 10 days");
				ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testAddMedicationEvery10thDay");	
