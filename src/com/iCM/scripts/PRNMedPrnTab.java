...
public class PRNMedPrnTab extends DriverTestCase
{	
	@Test
	public void testPRNMedPrnTab() throws Exception
	{			
		//Initialize objects
		...
		try{
				...
				prnHelper.verifyPRNMed("PRNMMedical","PRN Med Daily");
				ExecutionLog.Log("Pass");
				...
				//Verify Medication in the tab
				ExecutionLog.Log("Verify Medication in the tab");
				prnHelper.verifyPRNMed("PRNNMedical","PRN Med Daily");
				ExecutionLog.Log("Pass");
				...
				//Verify Medication in the tab
				ExecutionLog.Log("Verify Medication in the tab");
				prnHelper.verifyPRNMed("PRNEMedical","PRN Med Daily");
				ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testPRNMedPrnTab");	
