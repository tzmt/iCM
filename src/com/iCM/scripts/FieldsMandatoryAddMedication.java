...
public class FieldsMandatoryAddMedication extends DriverTestCase
{	
	@Test
	public void testFieldsMandatoryAddMedication() throws Exception
	{			
		//Initialize objects
		...
		try{
			...
			residentHelper = new ResidentHelper(getWebDriver());
				...
				//Verify Quantity field is not mandatory.
				ExecutionLog.Log("Verify Quantity field is not mandatory.");
				echartHelper.verifyItemNot("AddMedication.QuantityVali");
				ExecutionLog.Log("Pass");
				...
				//Verify Phycision field is not mandatory.
				ExecutionLog.Log("Verify Quantity field is not mandatory.");
				echartHelper.verifyItemNot("AddMedication.PhysicianVali");
				ExecutionLog.Log("Pass");
				...
				//Checked the ' Is this a Controlled Medication ?' checkbox.
				ExecutionLog.Log("Verify Quantity field is not mandatory.");
				...
				//Verify Quantity field is mandatory.
				ExecutionLog.Log("Verify Quantity field is mandatory.");
				echartHelper.verifyItem("AddMedication.QuantityVali");
				ExecutionLog.Log("Pass");
				
				//Verify Phycision field is  mandatory.
				ExecutionLog.Log("Verify Quantity field is mandatory.");
				echartHelper.verifyItem("AddMedication.PhysicianVali");
				ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testFieldsMandatoryAddMedication");	
