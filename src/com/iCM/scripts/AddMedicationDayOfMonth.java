...
public class AddMedicationDayOfMonth extends DriverTestCase
{	
	@Test
	public void testAddMedicationDayOfMonth() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			residentHelper = new ResidentHelper(getWebDriver());
				...
				echartHelper.click("AddMedication.DayOfMonth");
				ExecutionLog.Log("Pass");
				...
				ExecutionLog.Log("Select Days of month");
				echartHelper.selectDays();
				ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testAddMedicationDayOfMonth");	
