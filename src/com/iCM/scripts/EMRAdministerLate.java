...
public class EMRAdministerLate extends DriverTestCase
{	
	@Test
	...
	{			
		...
		//	loginHelper.verifyTitle("iCM - Home");
			...
			eMRHelper.clickAdmin();
			ExecutionLog.Log("Pass");
			
			//Click Admin Late option
			ExecutionLog.Log("Click on Administer Late option");
			eMRHelper.mouseHover("EMR.AdminLate");
			ExecutionLog.Log("Pass");
			
			//Wait
			eMRHelper.waitForWorkAroundTime(3000);
			
			//Click Admin Late list option
			ExecutionLog.Log("Click on Administer Late list option");
			eMRHelper.clickPop("EMR.AdminLatePop");
			ExecutionLog.Log("Pass");
			...
			ExecutionLog.Log("Verify Date is populated");
			eMRHelper.verifyFieldPopulated("EMR.DateField");
			ExecutionLog.Log("Pass");
			
			ExecutionLog.Log("Verify time is populated");
			//eMRHelper.verifyFieldPopulated("EMR.TimeField");
			ExecutionLog.Log("Pass");
