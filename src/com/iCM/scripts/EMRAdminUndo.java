...
public class EMRAdminUndo extends DriverTestCase
{	
	@Test
	public void testEMRAdminUndo() throws Exception
	{			
		...
		try{
			...
			residentHelper = new ResidentHelper(getWebDriver());
				...
				//Verify administered
				ExecutionLog.Log("Click on Admin Button");
				eMRHelper.verifyItemText("Admin.AdminBy","Administered");
				ExecutionLog.Log("Pass");
				
				//Verify Undo Button available
				ExecutionLog.Log("Verify Admin Undo Button");
				eMRHelper.verifyItem("Admin.AdminUndo");
				ExecutionLog.Log("Pass");
				
				//Click on Undo button
				ExecutionLog.Log("Click on Undo Button");
				eMRHelper.click("Admin.AdminUndo");
				ExecutionLog.Log("Pass");
				
				//Verify Undo Button working fine
				ExecutionLog.Log("Verify Undo Button working fine");
				eMRHelper.verifyItem("Admin.AdminButton");
				ExecutionLog.Log("Pass");		
		}
		catch (Error e) 
		{
			captureScreenshot("testEMRAdminUndo");	
