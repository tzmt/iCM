...
public class RoutineMedication extends DriverTestCase
{	
	@Test
	public void testRoutineMedication() throws Exception
	{			
		//Initialize objects
		...
		try{
			...
			residentHelper = new ResidentHelper(getWebDriver());
				...
				echartHelper.verifyItemText("AddMedication.MediType", "Routine");
				ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testRoutineMedication");	
