...
public class Omission extends DriverTestCase
{	
	@Test
	public void testOmission() throws Exception
	{			
		//Initialize objects
		...
		try{
			...
			residentHelper = new ResidentHelper(getWebDriver());
				...
				//Click on 'Omission' dropdown
				ExecutionLog.Log("Click on Omission Dropdown");
				echartHelper.click("Omission.OmiDropdown");
				ExecutionLog.Log("Pass");
				
				//Select Add Omission
				ExecutionLog.Log("Select Add Omission");
				echartHelper.click("Omission.AddOmission");
				ExecutionLog.Log("Pass");
				
				//Select Omission type
				ExecutionLog.Log("Select Omission type");
				echartHelper.select("Omission.SelectTypeOmission","Omission");
				ExecutionLog.Log("Pass");
				
				//Open Medication dropdown
				ExecutionLog.Log("Open Medication dropdown");
				echartHelper.click("Omission.MedicationDrpdwn");
				ExecutionLog.Log("Pass");
				
				//Search Medicine
				ExecutionLog.Log("Open Medication dropdown");
				echartHelper.type("D-Cold Total","Omission.SearchMedicationOmission");
				ExecutionLog.Log("Pass");
				
				//Select Medicin
				ExecutionLog.Log("Select Medicine");
				echartHelper.click("Omission.DMedicine");
				ExecutionLog.Log("Pass");

				//Enter result
				ExecutionLog.Log("Enter result");
				echartHelper.type("Feeling good","Omission.ResultOmission");
				ExecutionLog.Log("Pass");
				
				//Click on 'Save' button
				ExecutionLog.Log("Click on Save button");
				echartHelper.click("Omission.SaveOmission");
				ExecutionLog.Log("Pass");
				
				echartHelper.waitForWorkAroundTime(3000);
				
				//Verify Ommited
				ExecutionLog.Log("Verify Ommited");
				echartHelper.verifyItemText("Omission.VerifyOmission","Record updated successfully.");
				ExecutionLog.Log("Pass");
				
				//Click on 'Ok' button
				ExecutionLog.Log("Click on Ok button");
				echartHelper.click("Omission.OkOmission");
				ExecutionLog.Log("Pass");
				
				//Click on 'All' tab
				ExecutionLog.Log("Click on 'All' tab");
				echartHelper.click("AddMedication.AllTab");
				ExecutionLog.Log("Pass");
				
				//Verify updated omission
				ExecutionLog.Log("Verify updated omission");
				echartHelper.verifyItemText("Omission.OmissionVerify","Omitted");
				ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testOmission");	
