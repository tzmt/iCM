...
public class AddMedicationEvery14thDay extends DriverTestCase
{	
	@Test
	public void testAddMedicationEvery14thDay() throws Exception
	{			
		//Initialize objects
		...
		try{
			...
			residentHelper = new ResidentHelper(getWebDriver());
				...
				echartHelper.select("AddMedication.FrequencyDrpdwn","Every 14 days");
				ExecutionLog.Log("Pass");
				...
				echartHelper.verifyBlackOutOtherDay("Every 14 days");
				ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testAddMedicationEvery14thDay");	
