...
public class AddMedicationEveryOtherDay extends DriverTestCase
{	
	@Test
	public void testAddMedicationEveryOtherDay() throws Exception
	{			
		//Initialize objects
		...
		try{
			...
			residentHelper = new ResidentHelper(getWebDriver());
				...
				echartHelper.select("AddMedication.FrequencyDrpdwn","Every Other Day");
				ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testAddMedicationEveryOtherDay");	
