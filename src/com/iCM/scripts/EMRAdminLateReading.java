...
public class EMRAdminLateReading extends DriverTestCase
{	
	@Test
	public void testEMRAdminLateReading() throws Exception
	{			
		...
		try{
			...
			residentHelper = new ResidentHelper(getWebDriver());
				...
				eMRHelper.clickOnSecond("Admin.AdminDropdown","Admin.AdminLate","Admin.AdminReading","Admin.AdminLateItem","Admin.AdminLateReading");
				ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testEMRAdminLateReading");	
