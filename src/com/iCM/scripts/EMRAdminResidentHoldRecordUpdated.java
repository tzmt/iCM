...
public class EMRAdminResidentHoldRecordUpdated extends DriverTestCase
{	
	@Test
	public void testEMRAdminResidentHoldRecordUpdated() throws Exception
	{			
		...
		try{
			...
			residentHelper = new ResidentHelper(getWebDriver());
				...
				//Click on Resident Hold
				ExecutionLog.Log("Click on ReResident Refused");
				eMRHelper.clickOnSecond("Admin.AdminDropdown", "AdminOmission", "Admin.AdminReading","Admin.ResidentRefused","Admin.ResidentHold");
				ExecutionLog.Log("Pass");
				...
				//verify Fields are requered
				ExecutionLog.Log("verify Fields are requered");
				eMRHelper.verifyItem("Admin.Required");
				ExecutionLog.Log("Pass");
				
				//Open To date claender
				ExecutionLog.Log("Open To date claender");
				eMRHelper.click("Admin.ToField");
				ExecutionLog.Log("Pass");
				...
				//Select month
				ExecutionLog.Log("Select Month");
				eMRHelper.select("Admin.Month", "Sep");
				ExecutionLog.Log("Pass");
				
				//Select date
				ExecutionLog.Log("Select date");
				eMRHelper.clickAt("Admin.Date","3");
				ExecutionLog.Log("Pass");
				...
				//Go to Error&Ommision page via deep link
				ExecutionLog.Log("Go to Error&Ommision page via deep link");
				visit("AdministerMed/ErrorsAndOmissions/"+id);
				ExecutionLog.Log("Pass");
				
				//Verify title
				ExecutionLog.Log("Verify title");
				echartHelper.verifyTitle("Errors & Omissions");
				ExecutionLog.Log("Pass");
				
				//Click on 'Omission' button
				ExecutionLog.Log("Click on 'Omission' button");
				eMRHelper.click("Admin.OmmisionTab");
				ExecutionLog.Log("Pass");
				
				//Verify FORM & TO Date
				ExecutionLog.Log("Verify FORM & TO Date");
				eMRHelper.verifyToForm("Admin.ToFromField");
				ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testEMRAdminResidentHoldRecordUpdated");	
