...
public class AddMedicationEvery7thDay extends DriverTestCase
{	
	@Test
	public void testAddMedicationEvery7thDay() throws Exception
	{			
		//Initialize objects
		...
		try{
			...
			residentHelper = new ResidentHelper(getWebDriver());
				...
				echartHelper.select("AddMedication.FrequencyDrpdwn","Every 7 days");
				ExecutionLog.Log("Pass");
				...
				echartHelper.verifyBlackOutOtherDay("Every 7 days");
				ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testAddMedicationEvery7thDay");	
