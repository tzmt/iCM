...
public class AddTaskWithComplete extends DriverTestCase
{	
	@Test
	public void testAddTaskWithComplete() throws Exception
	{			
		//Initialize objects
		...
		try{
			...
			taskHelper.verifyFieldText("VerifyStatus", "Completed");
			ExecutionLog.Log("Pass");
		...
		{
			captureScreenshot("testAddTaskWithComplete");	
